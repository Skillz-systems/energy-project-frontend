...
const ProceedButton: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    // gradient: "bg-[#FEF5DA] border relative bg-[#FEF5DA] p-4 rounded-full before:content-[''] before:absolute before:inset-0 before:border before:border-transparent before:border-[1px] before:rounded-full before:bg-gradient-to-r before:from-[#982214] before:to-[#F8CB48] before:z-[-1]",
